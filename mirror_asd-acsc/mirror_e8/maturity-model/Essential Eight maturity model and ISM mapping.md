...
- [**Essential Eight maturity model and ISM mapping (October 2024)*1.06MB .pdf***](https://www.cyber.gov.au/sites/default/files/2025-03/Essential%20Eight%20maturity%20model%20and%20ISM%20mapping%20%28October%202024%29.pdf)
- [**Essential Eight maturity model and ISM mapping (October 2024)*21KB .xlsx***](https://www.cyber.gov.au/sites/default/files/2025-07/Essential%20Eight%20maturity%20model%20and%20ISM%20mapping%20%28October%202024%29.xlsx)
...
This publication provides a mapping between the [*Essential Eight maturity model*](https://www.cyber.gov.au/business-government/asds-cyber-security-frameworks/essential-eight) and the [*Information security manual*](https://www.cyber.gov.au/business-government/asds-cyber-security-frameworks/ism) (ISM).

## **Mapping between the *Essential Eight maturity model* and the ISM**

- [Mapping in CSV](e8mm_ism_mapping.csv)
- [Mapping in Markdown](e8mm_ism_mapping.md)
- [Mapping in JSON](e8mm_ism_mapping.json)
