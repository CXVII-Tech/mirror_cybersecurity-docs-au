...
**ISM | September 2025 changes**

# Guidelines for cryptography

## Cryptographic implementation assurance

The existing control recommending that *cryptographic equipment or applications that have completed a*

*Common Criteria evaluation against a Protection Profile are used when encrypting media that contains OFFICIAL: Sensitive or PROTECTED data* was amended to refer to ‘ASD-endorsed Protection Profiles’ instead. **[ISM-0457]**
...
Existing controls referencing ‘cryptographic equipment and applications’ were amended to refer to

‘cryptographic equipment, applications and libraries’ instead. **[ISM-0455, ISM-0457, ISM-0465, ISM-0471, ISM-0481, ISM-1917]**
